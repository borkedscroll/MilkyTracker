...
#ifndef SECTIONPIANOROLL__H
#define SECTIONPIANOROLL__H
...
class SectionPianoRoll : public SectionAbstract
{
private:
...
public:
	SectionPianoRoll(Tracker& tracker);
	virtual ~SectionPianoRoll();
...
private:
	...
	friend class DialogResponderPianoRoll;
