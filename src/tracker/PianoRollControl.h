...
//
/////////////////////////////////////////////////////////////////
#ifndef PIANOROLLCONTROL__H
#define PIANOROLLCONTROL__H
...
class PianoRollControl;
typedef void (PianoRollControl::*TPianoRollKeyBindingHandler)();
...
private:
	...
	// Keyboard shortcuts
	PPKeyBindings<TPianoRollKeyBindingHandler>* eventKeyDownBindings;
	PPKeyBindings<TPianoRollKeyBindingHandler>* scanCodeBindings;

	PPKeyBindings<TPianoRollKeyBindingHandler>* eventKeyDownBindingsMilkyTracker;
	PPKeyBindings<TPianoRollKeyBindingHandler>* scanCodeBindingsMilkyTracker;
	PPKeyBindings<TPianoRollKeyBindingHandler>* eventKeyDownBindingsFastTracker;
	PPKeyBindings<TPianoRollKeyBindingHandler>* scanCodeBindingsFastTracker;
...
public:
	PianoRollControl(pp_int32 id, PPScreen* parentScreen, EventListenerInterface* eventListener, 
						 const PPPoint& location, const PPSize& size, 
						 bool border = true);
	
	virtual ~PianoRollControl();
	...
	// --- these are defined in PianoRollControlTransposeHandler.cpp -----
...
private:
	...
	// {
	// private:
	// 	PianoRollControl& patternEditorControl;
	// 	PatternEditorTools::TransposeParameters transposeParameters;
	// 	TTransposeFunc transposeFunc;
	//
	// public:
	// 	TransposeHandlerResponder(PianoRollControl& thePatternEditorControl);
	//
...
private:
	bool executeBinding(const PPKeyBindings<TPianoRollKeyBindingHandler>* bindings, pp_uint16 keyCode);
